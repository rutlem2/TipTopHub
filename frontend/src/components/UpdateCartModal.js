...
const UpdateCartModal = (props) => {
    ...
    const handleDisplay = (quantity, isValidQuantity) => {
        if (isValidQuantity)
        {
            ...
            document.getElementById("update-cart-button").disabled = false;
        }
       else
       {
    ...
    const handleUpdateCart = async () => {
        ...
        let response = await fetch(`/shop/edit/`, {
            method: "PUT",
            headers: {
        ...
        {
            props.setCartItemsCount((Number(document.getElementById("cart-items-count").innerHTML)-props.productQuantity) + quantity);
            showSuccessModal();
        }
    }
    ...
    const clearInputAndDisable = () => {
        ...
        document.getElementById("update-cart-button").setAttribute("disabled", "");
    }
        ...
        return (
            <Modal show={props.show} onShow={clearInputAndDisable} onHide={handleClose}>
                ...
                <Modal.Footer>
                    ...
                    <Button id="update-cart-button" variant="primary" onClick={handleUpdateCart}>
                        Update Cart
                    </Button>
                </Modal.Footer>
            </Modal>
